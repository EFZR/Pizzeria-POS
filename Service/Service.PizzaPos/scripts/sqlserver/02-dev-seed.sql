...
INSERT INTO
  dbo.Province (Provi_CountryId, Provi_Name)
VALUES
  (1, 'Francisco Morazan'),
  (1, 'Cortes'),
  (2, 'California'),
...
INSERT INTO
  dbo.Locality (Local_ProviId, Local_Name)
VALUES
  (1, 'Distrito Central'),
  (1, 'Ojojona'),
  (2, 'Puerto Cortes'),
...
INSERT INTO
  dbo.OrderDetail (OD_OrdId, OD_ProdId, OD_Quantity, OD_Price)
VALUES
...
-- Order ID 4, Product ID 5 (Hawaiian Pizza), Quantity 1, Price 10.99